                        ...
                        <div id="content">
                            ...
                            <div class="products-holder">
                                ...
                                <div class="middle">													
                                    <div class="cl"></div>
                                    <div class="searchdiv">
                                        <h1>Welcome to My Payment Gateway</h1></br>
                                    ...
                                    <div>
                                        ...
                                        <form>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <h3> Please enter below Card Details: </h3></br>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h2>Card Number:</h2></br>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2>Card Expiry Date: </h2></br>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="Cardexpiry" value="" /></br>
                                                    </td>
                                                </tr>
                                            </table>

                                            </br></br>
                                            <input class="buy_now_button" type="submit" value="Payment!!!" /></p>
                                        </form>
