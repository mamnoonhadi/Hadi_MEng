<%-- 
    ...
    Khaled   12195227
    Yaser    13171852
    This is page where Admin can see the Items where he/she can select the delete button.
--%>
                        ...
                        <div id="content">
                            ...
                            <div class="products-holder">
                                ...
                                <div class="middle">													
                                    <div class="cl"></div>
                                    <div class="searchdiv">
                                        <h1>Welcome to Product Delete Page.Here Admin can only delete Items</h1></br>
                                        <h2>Please click on the Delete button which you want to delete. </h2></br>
                                    </div>
