<%-- 
    ...
    This is page Administrator page which will come display after successfully login as Admin
--%>
                            ...
                            <div id="content">
                                ...
                                <table >
                                    <tr>
                                        ...
                                        <td class="chkoutbtn">
                                            <a href="Updatedisplay">Edit Product</a>
                                        </td>
                                        <td class="chkoutbtn">
                                            <a href="DeleteData">Delete Product</a>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div class="products-holder">
                                    ...
                                    <div class="middle">													
                                        <div class="cl"></div>
                                        <div class="searchdiv">
                                            <h1>Welcome to Administrator Page. Here Admin can Add, Update and Delete Items</h1></br>
