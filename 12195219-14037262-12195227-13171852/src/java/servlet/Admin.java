 ...
 * This is Admin Servlet, Where we are validating the users based on thier roles
 */
package servlet;
...
public class Admin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // creating the Product list by using entity class
            ...
            // Geting the URole from the Jsp page
            Users user = (Users) request.getAttribute("urole");
            // Validating the users based on the roles and redirecting the page according to it
