 ...
 * This Servlet will delete the Product as selected by admin
 */
package servlet;
...
public class Delete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String str = "Product Name: " + pdtupdate.getProductName() + " Deleted";
            // remove command is for deletion from the Table
            entityManager.remove(pdtupdate);
            // End here
            tx.commit();
            entityManager.close();
            //Calling this method for mainting the logs
            sendJMSMessageToDest(str);
            // Printing message and creating the new link
